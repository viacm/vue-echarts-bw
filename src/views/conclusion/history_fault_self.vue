<template>
  <div class="fault_diagnosis">
    ...
    <span
      ...
      >设备故障诊断知识服务</span
    >
    <div class="search-input-diagnosis-5">
      <input
        type="text"
      ...
      />
      <!-- 这是一个小叉叉，点击它可清除输入框内容 -->
      <span class="search-reset-diagnosis-5" @click="clearInput()">&times;</span>
      <button class="search-btn-diagnosis-5" @click="search()">故障诊断</button>
    </div>
    <ul class="home-kind">
